...
- Lower-confidence re-audit (2026-08-13): U-01 is fixed in `fc82fea`; U-10 in `51c476e`; U-16 in `e6bf868`; U-02, U-03, U-05, and U-06 in `7edcc3b`; U-07 and U-08 in `7edc8c2`; U-11 in `9898128`; U-12 in `8efcdfe`; and the concrete hardware-facing U-14 ranges in `73d62ec`. U-09 and U-13 were already bounded in the reconciled tree. U-04 and U-15 remain design/policy investigations rather than confirmed drop-in fixes. U-14 remains an ongoing parser-audit category for future fields, not permission to invent hardware defaults.
