...
- Latest behavioral head: `52136de`
- Current TideWM version on the branch: `0.90.97`
...
- Medium still open or awaiting a fresh audit: M-24, M-37, M-43, M-45, M-47, M-48, and M-50 through M-73. (M-03 fixed 2026-08-13 in `7f97c04`; M-31 fixed 2026-08-13 in `854b223`; M-38 fixed 2026-08-13 in `b473f67`; M-39 fixed 2026-08-13 in `1e5348c`; M-40 fixed in `911b942` and completed in `5fe5db4`; M-41 fixed 2026-08-13 in `27c9489`; M-42 fixed 2026-08-13 in `bc38869`; M-44 fixed 2026-08-13 in `52136de`; M-46 fixed 2026-08-13 in `5f0e15e`; M-49 fixed 2026-08-13 in `2c466d6`; M-74 fixed 2026-08-13 in `6e2f42e`; M-11 fixed 2026-08-09 in `441d559` — see their finding bodies.) M-24 and M-50 got **partial fixes/mitigations only, not full closes** — see their finding bodies before treating either as resolved: M-24's leak (`eb9107b`, 2026-08-13) is now observable and bounded, not eliminated; M-50's stale threshold (`bdbef36`, 2026-08-13) is corrected but the finding's "cannot judge the selected feature set" half is untouched.
