...
- Current implementation head: `2c466d6`
- Current TideWM version on the branch: `0.90.63`
...
- Medium still open or awaiting a fresh audit: M-24, M-31, and M-37 through M-45, M-47, M-48, M-50 through M-74. (M-03 fixed 2026-08-13 in `7f97c04`; M-46 fixed 2026-08-13 in `5f0e15e`; M-49 fixed 2026-08-13 in `2c466d6`; M-11 fixed 2026-08-09 in `441d559` — see their finding bodies.) M-24 got a **mitigation** in `eb9107b` (2026-08-13, observability/bounding only, not a real fix — see the finding body) but stays in the open list: the underlying stuck-library-call leak is inherent to threading a blocking C API from Rust without portable thread cancellation, and a future session should not treat this as resolved.
